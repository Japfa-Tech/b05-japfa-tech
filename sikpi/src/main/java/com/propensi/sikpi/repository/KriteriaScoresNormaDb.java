...
@Repository
@Transactional
public interface KriteriaScoresNormaDb extends JpaRepository<KriteriaScoresNorma, Long> {
    List<KriteriaScoresNorma> findByBorangPenilaian(BorangPenilaianNorma borangPenilaianNorma);
}
